...
<div className="w-[90%] lg:w-1/2 sm:mt-20 mt-20 bg-black p-5 text-teal-500 rounded-xl shadow-md border-2 border-white">
  ...
  <form>
    ...
    <button
      type="submit"
      className="bg-teal-500 text-white px-4 py-2 rounded-md hover:bg-teal-600 focus:outline-none focus:ring focus:border-blue-300"
      onClick={addNote}
    >
      Add Note
    </button>
